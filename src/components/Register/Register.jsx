...
const Register = () => {
  ...
  const handleRegister = (e) =>{
      ...
      if(password.length<6){
        ...
        setRegisterError('Your password should have at least one uper case characters.')
        return;
      }
    ...
    <div className="relative top-40  ">
      ...
      <div className="mx-auto md:w-1/2  bg-yellow-50 text-center rounded-lg p-10">
        ...
        <form className="w-1/2 " onSubmit={handleRegister}>
          <input className="mb-4 w-full bg-white border rounded-md py-2 px-4" type="email" name="email" id="" required placeholder="Enter your email..."/>
          <br />
